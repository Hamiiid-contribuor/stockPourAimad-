...
public class ProjetController implements Serializable {
    ...
    public List<Projet> findProjetByAbonne() {
        if (projets == null) {
            System.out.println("SessionUtil.getConnectedUser() ==> "+SessionUtil.getConnectedUser()); 
            System.out.println("SessionUtil.getConnectedUser().getAbonne() ==> "+SessionUtil.getConnectedUser().getAbonne());
            System.out.println("SessionUtil.getConnectedUser().getAbonne().getProjets() ==> "+SessionUtil.getConnectedUser().getAbonne().getProjets());
            projets = SessionUtil.getConnectedUser().getAbonne().getProjets();
        }
        return projets;
    }
    ...
    public List<Projet> getItems() {
        if (items == null) {
            items = (SessionUtil.getConnectedUser().getAbonne().getProjets());
        }
        return items;
    }
    ...
    public List<Projet> getItemsAvailableSelectMany() {
        return (SessionUtil.getConnectedUser().getAbonne().getProjets());
    }
